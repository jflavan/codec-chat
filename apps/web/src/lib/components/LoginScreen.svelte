...
<div class="login-screen" transition:fade={{ duration: 300 }}>
	<div class="login-content">
		...
		<h1 class="sr-only">Codec — Real-time chat</h1>
		<p class="tagline" aria-hidden="true">Real-time chat, open source.</p>

		<div class="sign-in-section" aria-labelledby="sign-in-heading" role="region">
...
<style>
	...
	/* Visually hidden — present for screen readers only */
	.sr-only,
	.form-heading {
		position: absolute;
		width: 1px;
