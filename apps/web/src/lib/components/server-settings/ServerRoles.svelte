					...
					{#if editingRoleId === role.id}
						<div class="role-edit-panel">
							<div class="role-edit-header">
								<label for="edit-role-name-{role.id}" class="sr-only">Role name</label>
								<input
								...
								/>
								<label for="edit-role-color-{role.id}" class="sr-only">Role color</label>
		...
		<div class="create-role">
			...
			<div class="create-role-form">
				...
				<input
					...
					maxlength={100}
				/>
				<label for="new-role-color" class="sr-only">Role color</label>
