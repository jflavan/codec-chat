<script lang="ts">
	...
	function autoResize(): void {
		if (!inputEl) return;
		// Reset to single-line height so scrollHeight reflects true content size.
		// Using 'auto' here causes browsers to use the rows attr default, which can
		// be taller than our desired baseline.
