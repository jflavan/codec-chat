...
namespace Codec.Api.Migrations
{
    ...
    [Migration("20260412110000_AddRehostingMediaToActiveImportIndex")]
    partial class AddRehostingMediaToActiveImportIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Codec.Api.Models.DiscordEntityMapping", b =>
                {
                    ...
                    b.Property<Guid>("CodecEntityId")
                        .HasColumnType("uuid");

                    b.Property<string>("DiscordEntityId")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<Guid>("DiscordImportId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Codec.Api.Models.DiscordImport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ImportedChannels")
                        .HasColumnType("integer");

                    b.Property<int>("ImportedMembers")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Codec.Api.Models.DiscordUserMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CodecUserId");

                    b.HasIndex("ServerId", "DiscordUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Codec.Api.Models.Message", b =>
                {
                    ...
                    b.Property<string>("ImportedAuthorAvatarUrl")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");

                    b.Property<string>("ImportedAuthorName")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("Codec.Api.Models.DiscordImport", b =>
                {
                    b.HasOne("Codec.Api.Models.User", "InitiatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Codec.Api.Models.DiscordUserMapping", b =>
                {
                    b.HasOne("Codec.Api.Models.User", "CodecUser")
                        .WithMany()
                        .HasForeignKey("CodecUserId")
                        .OnDelete(DeleteBehavior.SetNull);
