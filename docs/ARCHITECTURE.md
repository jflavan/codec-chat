...
- Fields: Id, DiscordImportId (FK → DiscordImport), ServerId (FK → Server), DiscordEntityId, EntityType (Role/Category/Channel/Message/Emoji/PinnedMessage), CodecEntityId
