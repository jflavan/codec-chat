...
- ✅ **Global Admin** — configurable global admin role that can delete any server, channel, or message and kick any member regardless of ownership; configured via `GlobalAdmin:Email` application setting (Key Vault in production) and seeded at startup
